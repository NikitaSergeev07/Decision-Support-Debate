...
Ниже уже подготовлены ссылки для GitHub-описания. Чтобы они отображались в репозитории, положите ваши скриншоты в папку `docs/screenshots/` с указанными именами.
